...
public class FrmPrincipal extends JFrame {
	...
	public FrmPrincipal() {
		...
		lblImage.setIcon(new ImageIcon("/home/leticia/eclipse-workspace/TrabalhoFInal/TrabalhoFinal/src/trabalhofinal/view/hotelaria.jpg")); 

		GroupLayout gl_contentPane = new GroupLayout(contentPane);
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addComponent(lblImage, GroupLayout.PREFERRED_SIZE, 540, Short.MAX_VALUE)
		);
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addComponent(lblImage, GroupLayout.PREFERRED_SIZE, 241, Short.MAX_VALUE)
		);
